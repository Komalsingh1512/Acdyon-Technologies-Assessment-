  ...
  return (
    <section className="bg-bg-primary px-[22px] md:px-[40px] lg:px-[min(max(4vw,40px),120px)] py-[20px] md:py-[40px]">
      <div className="max-w-[1600px] mx-auto grid grid-cols-1 md:grid-cols-2 gap-[20px] md:gap-[32px]">
        ...
        <article className="group bg-[#fbfbfd] dark:bg-[#1d1d1f] rounded-[24px] overflow-hidden flex flex-col items-center outline-none focus-visible:ring-2 focus-visible:ring-accent-link">
          ...
          {/* ImageZone */}
          <div className="w-full flex-1 flex items-end justify-center overflow-hidden mt-10 md:mt-14">
            <img 
              src="/images/iphone_17_.jpg" 
              alt="iPhone 17" 
              className="w-[85%] max-w-[400px] h-auto object-contain mix-blend-multiply dark:mix-blend-screen" 
            />
          </div>
        </article>
        ...
        <article className="group bg-[#fbfbfd] dark:bg-[#1d1d1f] rounded-[24px] overflow-hidden flex flex-col items-center outline-none focus-visible:ring-2 focus-visible:ring-accent-link">
          ...
          <div className="w-full flex-1 flex items-end justify-center overflow-hidden mt-10 md:mt-14">
             <img 
               ...
               alt="iMac 24-inch" 
               className="w-[90%] max-w-[550px] h-auto object-contain mix-blend-multiply dark:mix-blend-screen" 
             />
          </div>
        </article>
      </div>
